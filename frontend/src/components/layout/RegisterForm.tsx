...
const registerSchema = z.object({
    username: z.string().min(3, "Au moins 3 caractères").max(50, "Maximum 50 caractères"),
...
export function RegisterForm() {
    ...
    const onSubmit = async (data: RegisterFormValues) => {
        try {
            ...
            form.setError("root", {
                message: apiError.message ?? "Erreur lors de l'inscription",
            })
        }
    }
    ...
    return (
        <main className="flex h-full min-h-0 flex-col px-4 py-10 sm:px-6 lg:px-10 lg:py-12 xl:px-16">
            <div className="flex min-h-0 flex-1 flex-col justify-center">
                <Card className={cn(
                    "w-full border-border/70 border-t-2 border-t-emerald-600 shadow-lg",
                    "ring-1 ring-foreground/10 backdrop-blur-md",
                    "dark:border-emerald-950/50 dark:border-t-emerald-500",
                )}>
                    <CardHeader className="space-y-1 pb-2">
                        <CardTitle className="text-xl tracking-tight">Créer un compte</CardTitle>
                        <CardDescription>
                            Rejoignez MedTrading et commencez à tracker vos trades.
                        </CardDescription>
                    </CardHeader>
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4" noValidate>
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    ...
                                                    <Input placeholder="mohamed" className="h-10 pl-9" {...field} />
                                                </div>
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                        ...
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <div className="relative">
                                                    ...
                                                    <Input type="email" placeholder="vous@exemple.fr" className="h-10 pl-9" {...field} />
                                                </div>
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                ...
                                <Button
                                    ...
                                    size="lg"
                                    className={cn(
                                        "h-11 w-full gap-2 font-semibold text-white",
